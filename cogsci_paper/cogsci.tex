...
Wordbank now includes data in four languages: English, Spanish, Norwegian (Kristoffersen 2013, Simonsen 2014), and Danish (Andersen 2006), including both cross-sectional and longitudinal data.
...
\end{tabular}
\caption{\label{table:measures} TODO}
\end{center}
\end{table}
...
\end{center}
\caption{\label{fig:grammar} TODO (English $n=4137$; Spanish $n=1094$; Norwegian $n=8505$; Danish $n=2074$)} 
\end{figure*}
...
\end{center}
\caption{\label{fig:coefs_grammar} TODO} 
\end{figure}
...
\caption{\label{fig:interactions} TODO}
...
\end{center}
\caption{\label{fig:coefs_noun_verb} TODO}
\end{figure}
