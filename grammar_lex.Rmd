...
Vocabulary composition for each language
```{r, message=FALSE,fig.width=9,fig.height=6}

# compute vocabulary composition for each speaker of one language
...
# compute cdi composition for each language
...
ggplot(filter(summary.vocab.comp,lexical_category != "Function Words"),
  ...
  scale_y_continuous(name = "Proportino of total vocabulary") +
