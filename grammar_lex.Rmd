...
admins <- get.administration.data(common.tables$momed,
  ...
  mutate(age.group = cut(age, breaks = c(15, 19, 23, 27, 31)),
         language = factor(language, levels = c("Norwegian", "English",
                                                "Danish", "Spanish")))

items <- get.item.data(common.tables$wordmapping,
                       common.tables$instrumentsmap) %>%
  mutate(language = factor(language, levels = c("Norwegian", "English",
                                                "Danish", "Spanish")))
...
```{r, include=FALSE}
#ggsave(file=("~/Documents/plots/grammar.png"), width=6, height=6, dpi=300)
```
...
```{r, include=FALSE}
#ggsave(file=("~/Documents/plots/coefs_wordform_complexity.png"), width=6, height=4, dpi=300)
```
...
```
```{r, include=FALSE}
#ggsave(file=("~/Documents/plots/norwegian_interactions.png"), width=8, height=4)
```
...
```
```{r, include=FALSE}
#ggsave(file=("~/Documents/plots/english_interactions.png"), width=8, height=4)
```
...
```
```{r, include=FALSE}
#ggsave(file=("~/Documents/plots/danish_interactions.png"), width=8, height=4)
```
...
```
```{r, include=FALSE}
#ggsave(file=("~/Documents/plots/spanish_interactions.png"), width=8, height=4)
```
...
```{r, include=FALSE}
#ggsave(file=("~/Documents/plots/composition_fit.png"), width=10, height=2.9, dpi=300)
```
