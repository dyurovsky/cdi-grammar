...
predicted.data[predicted.data$language=="Spanish",]$predicted <- 
  predict.lm(english.lm,predicted.data[predicted.data$language=="Spanish",])
predicted.data[predicted.data$language=="Norwegian",]$predicted <- 
  predict.lm(english.lm,predicted.data[predicted.data$language=="Norwegian",])
predicted.data[predicted.data$language=="Danish",]$predicted <- 
  predict.lm(english.lm,predicted.data[predicted.data$language=="Danish",])
```
...
Plot vocabulary composition by lexical category.
```{r, fig.width=10, fig.height=8}
