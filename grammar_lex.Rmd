...
linear.mod.coef.fun <- function(pos.prop, vocab.mean, age) {
  return(coef(lm(cdi.prop ~ I((vocab.mean*100)^2) + I(vocab.mean*100) * age + 0))["I(vocab.mean * 100):age"])
  }

linear.mod.se.fun <- function(pos.prop, vocab.mean, age) {
  return(summary(lm(cdi.prop ~ I((vocab.mean*100)^2) + I(vocab.mean*100) * age + 0))$coefficients["I(vocab.mean * 100):age", "Std. Error"])
  }
